...
def ShiftSignalByConst(Shift_value,Your_indices,Your_samples):
    if(Shift_value==500):
        file_name="output signals\output shifting by add 500.txt" # write here path of output shifting by add 500.txt
    elif(Shift_value==-500):
        file_name="output signals\output shifting by minus 500.txt" # write here path of output shifting by minus 500.txt
